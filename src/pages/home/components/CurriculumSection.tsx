  ...
  const chapters: Chapter[] = [
    ...
    },
    {
      ...
      items: [
        ...
        '文書の品質チェック',
        'Canvas機能で長文を共創する',
        'Gemsの基本的な使い方。自分専用AIを作る',
        'スマホ活用：移動中にアイデア出し',
        '音声入力で下書き作成',
        'AIと対話して思考整理（コーチング）',
        'プレゼン練習：AIにフィードバックをもらう',
      ],
    },
    {
      number: 5,
    ...
    },
    {
      ...
      items: [
        ...
        'Googleスプレッドシート：データ整理・分析・要約',
        'Googleスライド：構成案とスライド作成補助',
        'Googleドライブ：必要なファイルを即座に見つける',
        'Googleカレンダー/タスク：予定調整とToDoリスト化',
      ],
    },
    {
      number: 7,
      ...
      items: [
        '社内ルール（ガバナンス）の全体像',
        'AIに入力してはいけない情報（機密・個人情報）',
        '情報の伏せ字・置き換え（マスキング）／匿名化',
        '著作権・引用・転載の基礎知識',
        'ハルシネーション対策：事実確認の手順',
        '人が最終確認する運用の徹底',
        '自分への一歩：実務をDX化するコツ',
        'これからのAIと人間：共生とスキルの磨き方',
      ],
    },
  ];
