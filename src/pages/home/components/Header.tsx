      ...
      <nav className="px-6 lg:px-12 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="/recruitment" className="text-gray-700 hover:text-orange-500 font-medium transition-colors whitespace-nowrap cursor-pointer">
              提携社労士様募集
            </a>
            <button
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-gray-200 pt-4">
            <div className="flex flex-col gap-4">
              ...
              <a href="/recruitment" className="text-gray-700 hover:text-orange-500 font-medium transition-colors text-left cursor-pointer py-2">
                提携社労士様募集
              </a>
              <button
                onClick={() => scrollToSection('contact')}
